...
GO
EXECUTE sp_addrolemember @rolename = N'db_owner', @membername = N'CPDM_noverbey';


GO
EXECUTE sp_addrolemember @rolename = N'db_owner', @membername = N'CourseyC';


GO
EXECUTE sp_addrolemember @rolename = N'db_backupoperator', @membername = N'CPDM_noverbey';


GO
EXECUTE sp_addrolemember @rolename = N'db_backupoperator', @membername = N'CourseyC';
